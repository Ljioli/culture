...
Component({
	...
	lifetimes: {
		...
		ready: function () {
			...
			if (this.data.mode == 'minute') {
				this.data.startYear = 2025;
				this.data.endYear = 2025;
				if (this.data.item) this.data.item = '2025-01-01 ' + this.data.item;
			}
	...
	methods: {
		...
		pickerChange: function (e) {
			...
			let time = this._getTimeStr(value);
