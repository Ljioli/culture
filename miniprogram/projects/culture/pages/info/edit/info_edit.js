...
Page({
	...
	bindSubmitTap: async function (e) {
		try {
			...
			await cloudHelper.callCloudSumbit('info/edit', data, opts).then(res => {
				let node = {
			...
			await cloudHelper.transFormsTempPics(forms, 'info/', id, 'info/update_forms');
